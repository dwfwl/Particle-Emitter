...
inline void shader_create(const std::unique_ptr<Shader>& self, const char* vert, const char* frag)
{
...
inline void shader_use(const std::unique_ptr<Shader>& self)
{
...
inline void shader_delete(const std::unique_ptr<Shader>& self)
{
